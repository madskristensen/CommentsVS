...
2. **Check if the issue has been fixed** &mdash; try to reproduce it using the latest
   `master` or development branch in the repository.

3. **Isolate the problem** &mdash; ideally create an [SSCCE](http://www.sscce.org/) or
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/CommentsVS.git
   # Navigate to the newly cloned directory
   cd CommentsVS
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/madskristensen/CommentsVS.git
   ```
...
4. Commit your changes in logical chunks. Please adhere to these [git commit
   ...
   to the commit message. For instance: "Reflow: Fixes line wrapping for nested tags.\nFixes `#123`"
